...
export default function Status() {
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center h-96">
            ...
            <p className="text-gray-500 font-black uppercase tracking-widest text-[10px]">Synchronizing with Grid...</p>
        </div>
    );
    ...
    return (
        <div className="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="mb-12 flex justify-between items-end">
                <div>
                    <h2 className="text-4xl font-black text-gray-900 tracking-tight">Active Reports</h2>
                    <p className="text-gray-500 font-medium mt-2">Track the lifecycle of your filed complaints in real-time.</p>
                </div>
                <div className="flex items-center gap-3 px-4 py-2 bg-blue-50 rounded-full border border-blue-100">
                    <span className="w-2 h-2 bg-blue-600 rounded-full animate-ping"></span>
                    <span className="text-[10px] font-black text-blue-600 uppercase tracking-widest">Live Tracking Active</span>
                </div>
            </div>

            {complaints.length === 0 ? (
                <div className="bg-white rounded-[40px] border-2 border-dashed border-gray-100 p-20 text-center">
                    <h3 className="text-xl font-black text-gray-900 mb-2">No Reports Found</h3>
                    <p className="text-gray-400 font-medium">Your submission history is currently clear.</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 gap-6">
                    {complaints.map((complaint) => (
                        <div key={complaint._id} className="bg-white rounded-[32px] border border-gray-100 shadow-[0_15px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_25px_60px_rgba(0,0,0,0.06)] transition-all duration-500 overflow-hidden">
                            <div className="p-6 md:p-8">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3 mb-1">
                                                <span className="text-[10px] font-black tracking-widest text-blue-600 uppercase">{complaint.category}</span>
                                            ...
                                            <div className="flex items-center gap-3 mt-1.5">
                                                ...
                                                <span className="text-[10px] font-black text-blue-600 uppercase tracking-widest bg-blue-50 px-2 py-0.5 rounded-lg">
                                                    {complaint.village || 'Region Unified'}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">Your Description</h4>
                                    ...
                                    {complaint.adminResponse ? (
                                        ...
                                        <div className="flex items-center gap-2 text-gray-400">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-widest">Awaiting Authority Review...</span>
                                        </div>
                                    )}
                                </div>
                            </div>
